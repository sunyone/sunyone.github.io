...
class Logger():
    def __init__(self, logname, loglevel, logger):
        ...
        rotate_handler=RotatingFileHandler(logname, maxBytes=log_max_size, backupCount=log_backup)
...
if __name__ == '__main__':
    logger = Logger(logname='log.txt', loglevel=3, logger="young").getlog()
    logger.debug("This is level 1 info log")
